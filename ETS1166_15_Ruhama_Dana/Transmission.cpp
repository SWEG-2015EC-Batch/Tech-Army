...
time_in_seconds=419430400/960;//using the ASCII encoding to determine that 1 character is equal to 1 byte, figure out how many bytes per second it takes for the 400mb file
